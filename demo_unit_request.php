...
if(isset($_GET['ID'])){
	$str = "SELECT qty, items, purpose, date_needed, date_filed, CONCAT(emp_firstname,' ',emp_lastname), dept_name, amount FROM ems_equip_requisitions AS r
...
<html>
    ...
    <body onload="bread('<?php echo $_SERVER["PHP_SELF"];?>');">
        ...
        <div><span class="title">Request Demo Unit</span></div>
                            ...
                            <tr>
                             ...
                             <tr>
                              ...
                              <tr>
                                    ...
                                    <table border="0" width="100%" >
                                        ...
                                        <tr>
                                            <td colspan="2">
                                            	...
                                            	<input type="text" name="qty[]" class="qty" size="1" value="<?php echo $get_qty[0]; ?>"/><input type="text" name="item[]" size="58" value="<?php echo $get_item[0]; ?>"/>
												...
												<?php
													...
													if($result[0]){
														...
														for($i=1;$i<sizeof($index)-1;$i++){
															echo '<div id="s',$i,'">';
															echo '<input type="text" name="qty[]" class="qty" size="1" value="',$get_qty[$i],'"/><input type="text" name="item[]" size="58" value="',$get_item[$i],'"/><a href="javascript:remove(\'s',$i,'\');"><img src="icons/remove.png"/></a><br/>';
															echo '</div>';
														}
														echo '</div>';	
													}
                                ...
                                <tr>
                                <td colspan="2" align="right" style="padding-right:50px;"><a href="javascript:add(<?php echo $last_id;?>);"><img src="icons/plus.png"/></a></td>
                                </tr>
                              </tr>					  
                              <tr>
