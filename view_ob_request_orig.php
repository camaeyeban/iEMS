				...
				<div class="t">
                	<table border='0' width='100%' id="t_color">
						...
						<tr>
                            ...
                            <th width="14%">From-To</th>
                            <th width="10%">Name</th>
                            <th width="10%">Client/ Branch</th>
                            <th>Purpose</th>
                            <th width="6%">Departure</th>
                            <th width="6%">Arrival</th>
                            <th width="5%">Total duration</th>
							...
							<?php
								...
								while($result = mysql_fetch_array($rs)){		
									...
									echo '<td>',display_time(trim($result[6])),'</td>';
											
									//TL-2012/01/02 - Fixed display of Arrival
									//if($result[0]!="0000-00-00" && !($result[10] == $result[0])){
									if($result[7] > 1435){
										echo '<td>',display_time_2($result[7]),'</td>';
									}else{
										echo '<td>',display_time($result[7]),'</td>';
									}	
									
									echo '<td>',$result[8],'</td>';
									show_remarks($result[10]);
									echo '<td id="stat_val" style="color:',f_color($result[9]),';"><b>',$result[9],'</b></td>';																				
									echo '</tr>';
