...
$dblink = new mysql_db_connect();
	...
	if(isset($_POST['submit']) && $_POST['submit']=="apply"){
		...
		$str = "INSERT INTO ems_offset (offset_id, emp_num, date_Filed, date_ot, date_ot2, ot_hours, ot_hours2, accomplishment, 
					date_offset, date_offset2, remarks, status)
            ...
            <div id="cc">
                ...
                <table border='0' width='50%' class="t">
                    ...
                    <tr>
                        ...
                        <input type="text" name="ot_hours1" size="2" value="<?php echo $result[3]?>"/></td>
                    </tr>
                    <tr>
                        <td></td>
                        <?php 
                            ...
                            echo '<input type="checkbox" name="ot" value="day2" onclick="OT();" id="ot" '.$chk.'/> <label for="ot" style="font-size:11px;">Apply offset for 2-day OT.</label>';
                            echo '</td>';									
                        ?>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td></td>
                        <?php
                            echo '<td><span id="cal4" style="display:none;">',calendar4($result[7]),'</span><span id="dis2" style="padding:3px 0 3px 1px; background-color:#e2e2e2;">Select Date <img src="icons/iconCalendar.gif"/></span></td>';						
                        ?>
                    </tr>
                     <!--<tr>
