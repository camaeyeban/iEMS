    ...
    <div id="calendar-header" align="center">
        ...
        <form id="calendarform" name="calendarform" method="post" action="<?php echo($thispage);?>">
          <table align="center" cellpadding="1" cellspacing="0">
          	 <tr>
            	<td align="right"><select name="m" class="browser-default" onchange="javascript:submitCalendar();">
				  <?php
	    ...
	    <input name="selected_day" type="hidden" class="browser-default" id="selected_day" value="<?php echo($sld);?>" />
