...
-- 
-- Host: localhost
-- Generation Time: Sep 23, 2011 at 09:35 AM
...
INSERT INTO `ems_active_user` VALUES (1, 1, '1', 3);
...
INSERT INTO `ems_active_user` VALUES (19, 14, '111', 1);
...
INSERT INTO `ems_air_ticket` VALUES ('air-0002', 111, '2011-09-14', 'sample', 'sample', 'sample', 'sample', 'Aug-13-2011 11:00:00 PM', 'Aug-13-2011 11:50:00 PM', 'sample sample', '', '7000', 'Booked', 3);
...
INSERT INTO `ems_emp_dependents` VALUES (6, 111, 'neo', 'pamangking tunays', '2004-04-04');
INSERT INTO `ems_emp_dependents` VALUES (8, 111, 'jamil', 'girlfriend', '1990-11-06');
...
INSERT INTO `ems_equip_requests` VALUES ('rsv-0001', 111, '2011-09-14', 'meeting', 'iRipple', '2011-09-29', '2011-09-29', 1, 'Projector|Laptop|', 'Approved', '');
...
INSERT INTO `ems_equip_requisitions` VALUES ('ER2011002', 111, '2011-09-16', '2011-09-23', '1|', 'mouse|sdf|', 'hello', '', 'Pending', '');
...
INSERT INTO `ems_leave` VALUES ('lve-0001', 111, '2011-09-23', '2011-09-29', '2011-09-30', 2, 'AM PM ', 'Vacation Leave', 1, 'hapi vacation.', '', 'Pending');
...
INSERT INTO `ems_ob` VALUES ('ofb-0001', 111, '2011-09-16', 'iRipple', '2011-09-19', 'Network|', 'Pending', '', '510', '580', '645', 1.05, '780', 3.2);
...
INSERT INTO `ems_offset` VALUES ('off-0001', 111, '2011-09-16', '2011-09-01', '0000-00-00', 8, 0, 'ems', '2011-09-29', '0000-00-00', '', 'Pending');
...
INSERT INTO `ems_photos` VALUES (3, 111, 'photos/5493.jpg');
...
INSERT INTO `ems_remarks` VALUES (6, 'ovt-0025', 111, 'created: Sep 22, 2011 04:01:57 pm', '');
...
ALTER TABLE `ems_emergency_contacts`
  ADD CONSTRAINT `ems_emergency_contacts_ibfk_1` FOREIGN KEY (`emp_num`) REFERENCES `ems_employee` (`emp_num`);
...
ALTER TABLE `ems_equip_requests`
  ADD CONSTRAINT `ems_equip_requests_ibfk_1` FOREIGN KEY (`emp_num`) REFERENCES `ems_employee` (`emp_num`);
